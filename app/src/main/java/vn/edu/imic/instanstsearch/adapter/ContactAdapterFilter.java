...
public class ContactAdapterFilter extends RecyclerView.Adapter<ContactAdapterFilter.ContactHolder>
    ...
    public ContactAdapterFilter(Context mContext, List<Contact> listContact, OnContactListener contactListener) {
